...
EPGP_BB_HELP = {
    ...
    "    damagetaken by spell_id [min_damage] - получение min_damage урона от способности по id. По умолчанию - любого урона",
    "    buff by spell_id [min_staks] - получение min_staks стаков баффа/дебаффа. 1 по умолчанию",
...
EPGP_BB_RULE_DAMAGE_TAKEN_AMOUNT_BY_PH = "%d %s за получение более %s урона от %s"
